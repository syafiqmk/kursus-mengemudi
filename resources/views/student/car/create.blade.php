...
@section('content')
    <div class="row">
        <div class="col-md-8">
            <form action="{{ route('student.car.store') }}" method="post" enctype="multipart/form-data">
                @csrf

                <div class="mb-3">
                    <label for="">Registration Number</label>
                    <input type="text" name="reg-number" id="" class="form-control @error('regNumber') is-invalid @enderror" placeholder="Registration Number" autocomplete="off" required value="{{ old('regNumber') }}">
                    @error('regNumber')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="engine-capacity" id="" class="form-control @error('engineCapacity') is-invalid @enderror" placeholder="Engine Capacity" autocomplete="off" required value="{{ old('engineCapacity') }}">
